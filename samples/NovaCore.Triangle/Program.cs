...
static void PrintEarthDiagnostics(EarthPlanetaryScene scene)
{
    ...
    Console.WriteLine($"LOD: altitude threshold={EarthPlanetaryScene.LodConfiguration.NearFieldAltitudeRadii:R} radii; maximum level={EarthPlanetaryScene.MaximumLod}; initial six-root coverage.");
