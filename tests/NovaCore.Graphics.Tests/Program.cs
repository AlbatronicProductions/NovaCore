...
if(args.Contains("--florida-slab-camera-moving",StringComparer.Ordinal)){ActiveVesselCameraTests.MovingAndPrecision();return 0;}
if(args.Contains("--florida-slab-camera-costs",StringComparer.Ordinal)){ActiveVesselCameraTests.AllocationAndCosts();return 0;}
...
var tests = new (string, Action)[]
{
    ...
    ("Certified Florida publication costs", CertifiedContinuationCost.Run),
    ...
    ("Private Florida paired canonical propagation", PrivateFloridaPropagationTests.Run),
