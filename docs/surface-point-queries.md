...
`m14.1-canonical-surface-point-queries`. M14 remains open; see [current state](NOVACORE_CURRENT_STATE.md)
for the latest banked accomplishment. The banked M14.3 [contact generator](contact-generation.md)
