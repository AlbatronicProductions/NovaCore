...
internal static class BoundaryDriver
{
    ...
    private static void Main(string[] args)
    {
        ...
        Qualification.Save("attempt.json",new{runtime=RuntimeInformation.FrameworkDescription,process=Environment.ProcessId,
            thread=Environment.CurrentManagedThreadId,kind="saved accepted tuple diagnostic; no native/canonical world",sweeps=8});
        try
        {
            ...
            var b=Run(baseline);var p=Run(powered);Pair(baseline,powered,b,p);
