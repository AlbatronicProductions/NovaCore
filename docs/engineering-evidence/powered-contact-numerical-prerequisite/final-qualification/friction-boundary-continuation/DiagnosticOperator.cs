...
internal enum OperatorStatus { Ready,WrongThread,Busy,Invalidated,StaleLineage,InvalidDuration,UnsupportedSupport,
    BasisRefusal,DurationRefusal,LoadRefusal,DRefusal,ArithmeticFailure,StaleProposal,InstallFailure,CurrentInitializationRefusal,DiagnosticStopped }
...
internal sealed class RetainedOperator
{
        ...
        ReadOnlySpan<double> nativeCache,out Proposal proposal,out Diagnostics proof)
    {
        ...
        BoundaryPolicy.Observe("basis-transport",current,work);
        ...
        Scaled numerator=default,delta;double denominator=0;
