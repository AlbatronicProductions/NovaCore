...
| [M15.4 Unified Active-Vessel Camera](active-vessel-camera/README.md) | Vessel/celestial focus, follow, orbit and zoom with corrected rotating-Earth and time-warp horizon behavior. | BANKED at `6e1e8ef424eef4ad022a30ca4b2b261eb580b0ae`; tag `m15.4-unified-active-vessel-camera`. Historical camera review statuses remain provenance. |
| [M15.3 Canonical SRV-01 Florida Supported-Flight Foundation](srv01-surface-to-flight-foundation-final/README.md) | Consolidated accepted Stage1–5 contracts, final regression/identity/manual proof, residuals, cleanup and historical bank preparation. | BANKED at `544f25ad618bcad7a2753de69108ca3c4095df11`; tag `m15.3-canonical-srv01-florida-supported-flight-foundation`. Final simplified Florida slab manual acceptance PASS; Stage 6 closed. Pre-bank wording and child failures remain historical. |
| [SRV-01 Reusable Production Spacecraft Integration](srv01-production-integration/README.md) | Seven reusable part instances, sixteen explicit RCS jets, exact two-species accounting, current mass properties, runtime visual binding and KSA-method exhaust qualification. | M15.2 BANKED at c3de150db8563864d23c4951b4630559453d8f56. [Bank-preparation packet](srv01-production-integration/bank-preparation/README.md) is historical; its proposed wording is preserved. Historical failures and unattributed frame/save/restore tails remain disclosed. |
| [M15.1 Finite-Fuel Retained Powered Contact](powered-contact-bank-candidate/README.md) | Historical consolidated qualification, exact resource/physical/actuator publication, source-held ordinary solving, ready/apply lifecycle, manual acceptance and attribution/whitespace identity migrations. | BANKED; tag `m15.1-finite-fuel-retained-powered-contact`, including operative licensing. Reports retain pre-bank status and earlier failures; numerical and optimization history is not rewritten. |
| [M15.0 segmented powered free flight](segmented-powered-free-flight/final-qualification.md) | Separate finite-fuel free-flight consumer, exhaustion and coast. | Banked `4607d8c802006d5e1a01c595ab608cf53a4dab6b`; tag `m15.0-segmented-powered-free-flight`. |
| [Host-paced canonical contact servicing candidate](contact-episode-servicing/README.md) | Owner-authorized elapsed-host debt, four-interval service budget, retained publication continuity, host-partition bit witness and bounded contact development scene. | UNBANKED; numerical qualification retained, Unicode status and repeated manual acceptance pass; bounded whole-frame tail classification UNRESOLVED. |
| [M14.19 persistent BEPU contact publication](persistent-contact-publication/README.md) | Sibling atomic endpoint publication, same-phase acknowledgement, retained solver trajectory, deterministic history, refusal/terminal witnesses and bounded complete-path qualification. | ACCEPTED and BANKED at `fc6fbf269d7a8022ce2fe184aea0dfc94716db05`; tag `m14.19-persistent-bepu-contact-publication`. |
...
| [M14.8 exact-event Earth-relative observation](exact-event-earth-relative-observation/README.md) | Same-epoch Earth/craft numerical composition, Earth-only model boundary, canonical parity, real terrain, allocation and bounded performance. | [Banked contract](../spacecraft-earth-event-observation.md). |
...
| [M14.4 contact transaction](contact-response-transaction/README.md) | Atomic paired publication, exact-event impulse mapping, rejection, analytical oracle and complete transaction cost. | [Response contract](../contact-response-transaction.md). |
| [M14.5 isolated contact response](isolated-contact-response/README.md) | Qualified admission, canonical-zero-gap limit, numerical oracle, identity defenses and bounded CPU cost. | [Policy contract](../isolated-contact-response.md). |
| [M14.6 banked physical-event epochs](physical-event-epoch/README.md) | Exact rational identity/order, integral compatibility, resolved CLR accounting cause and accepted zero-allocation class validation. | [Epoch contract](../physical-event-epochs.md); [final validation](physical-event-epoch/ordinary-class-migration/README.md). |
