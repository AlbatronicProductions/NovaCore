...
|---|---|---|
| [SRV-01 Reusable Production Spacecraft Integration](srv01-production-integration/README.md) | Seven reusable part instances, sixteen explicit RCS jets, exact two-species accounting, current mass properties, runtime visual binding and KSA-method exhaust qualification. | Project Control ACCEPTED, UNBANKED. [Exact bank-preparation packet](srv01-production-integration/bank-preparation/README.md); M15.2 proposed only. Historical failures and unattributed frame/save/restore tails remain disclosed. |
