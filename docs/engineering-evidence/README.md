...
|---|---|---|
| [Unbanked Florida monotone contact certification](florida-monotone-contact-certification/README.md) | Continuous grading relation, whole-interval containment, source-derived derivative/rounding bounds, exact root identity, bounded refusal, real-Earth validation and cost. | [Candidate contract](../florida-monotone-contact-certification.md). |
