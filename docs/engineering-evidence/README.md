...
|---|---|---|
| [Canonical SRV-01 surface-to-flight foundation](srv01-surface-to-flight-foundation-final/README.md) | Consolidated accepted Stage1–5 contracts, final regression/identity/manual proof, residuals, cleanup and exact proposed banking paths. | UNBANKED; no milestone assigned. Final simplified Florida slab manual acceptance PASS; Stage6 closed. Historical child failures remain historical. |
