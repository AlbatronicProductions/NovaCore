...
| [Unbanked isolated contact response](isolated-contact-response/README.md) | Qualified admission, canonical-zero-gap limit, numerical oracle, identity defenses and bounded CPU cost. | [Policy contract](../isolated-contact-response.md). |
