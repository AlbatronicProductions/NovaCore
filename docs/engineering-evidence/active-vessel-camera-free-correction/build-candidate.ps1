...
dotnet build NovaCore.sln -c $Configuration --artifacts-path "$output/candidate" "-p:NativeBuildDirectory=active-vessel-camera-free-correction/native-$suffix" --nologo -v:q *> "$output/solution-$suffix.txt"
