...
$output=Join-Path $repo 'build/active-vessel-camera-free-correction/candidate/bin'
...
$identities | ConvertTo-Json -Depth 4 | Set-Content 'build/active-vessel-camera-free-correction/deployment.json'
