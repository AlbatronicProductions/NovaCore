...
from gauntlet import assess,ROOT,HERE
sha=assess.sha;verify_deployment=assess.verify_deployment

assert not (ROOT/'build/m13-regional-preparation-blocker').exists()
...
assert not target.exists() and not (ROOT/'build/m13-regional-preparation-blocker').exists()
