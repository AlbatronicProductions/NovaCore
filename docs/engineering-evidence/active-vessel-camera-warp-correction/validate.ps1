...
foreach($configuration in @('Debug','Release')) {
    ...
    foreach($gate in @('florida-slab-camera-static','florida-slab-camera-warp','florida-slab-camera-moving','florida-slab-camera-costs','florida-slab-correctness','florida-slab-solar','florida-slab-allocation','assembly-florida-presentation','assembly-florida-presentation-storage','assembly-florida-qualification')) {
