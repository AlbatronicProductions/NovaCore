...
$expected=[IO.Path]::GetFullPath('E:\NovaCore\docs\engineering-evidence\m13-regional-preparation-convergence')
...
if($manifest.files.Count -ne 8){throw 'Unexpected journal set'}
$paths=@()
...
Write-Output 'Removed eight verified uncompressed duplicates; all evidence retained losslessly.'
