...
public enum SimulationEventKind : byte { Marker = 1, ReplaceTrajectory = 2, NoOpMarker = 3, CelestialImpulse = 4, RigidBodyTorque = 5, SpacecraftForce = 6, SpacecraftContactImpulse = 7 }
