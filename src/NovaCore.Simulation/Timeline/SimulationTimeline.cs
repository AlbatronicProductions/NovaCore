...
public sealed class SimulationTimeline
{
    ...
    private SimulationScheduleStatus? ValidateRequest(SimulationInstant currentTime, SimulationEventRequest request)
    {
        ...
        if (request.Kind is not (SimulationEventKind.Marker or SimulationEventKind.ReplaceTrajectory or SimulationEventKind.NoOpMarker or SimulationEventKind.CelestialImpulse or SimulationEventKind.RigidBodyTorque)) return SimulationScheduleStatus.InvalidKind;
