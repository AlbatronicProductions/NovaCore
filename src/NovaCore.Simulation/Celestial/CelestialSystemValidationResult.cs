...
internal enum CelestialSystemValidationStatus : byte
{
    ...
    UnsupportedSampledInterpolationModel,
    InvalidSampledTimeDomain,
    SampledPayloadTimeDomainMismatch,
    NegativeSampleFirstIndex,
    InvalidSampleCount,
    SampleRangeOverflow,
    SampleRangeOutsideStorage,
    SampleCoverageMismatch,
    NonFiniteEphemerisSample,
