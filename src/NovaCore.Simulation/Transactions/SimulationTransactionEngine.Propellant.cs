...
internal sealed partial class SimulationTransactionEngine
{
    ...
    private bool PropellantMassMatches(PropellantResourceAuthority authority, out double total)
    {
        ...
        return PropellantInteger.TryAdd(definition.DryMassUnits, authority.RemainingUnits, out var sum) &&
            ...
            view.Spacecraft.TryGetTranslation(authority.Engine.Commands.Spacecraft, out _, out var physical) &&
            BitConverter.DoubleToInt64Bits(physical.MassKilograms) == BitConverter.DoubleToInt64Bits(total) &&
            view.Spacecraft.TryGetRigidBody(authority.Engine.Commands.Spacecraft, out var angular) &&
            angular.PrincipalInertia == definition.Values.DryInertia;
    }
        ...
        PropellantDefinition? definition, out PropellantResourceAuthority? authority)
    {
        ...
        try
        {
            ...
            authority = new(engine, definition);
