...
void main(){
  ...
  gl_Position=opacity>0.0?frameData.camera.viewProjection*vec4(inPositionHigh,1.0)+
    frameData.camera.viewProjection*vec4(inPositionLow,0.0):vec4(2.0,2.0,2.0,1.0);
}
