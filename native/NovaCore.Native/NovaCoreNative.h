...
struct alignas(16) NcPlanetaryGpuConstants { float cameraBodyX, cameraBodyY, cameraBodyZ, radius; float refinementThreshold, nearFieldAltitudeRadii, padding0, padding1; uint32_t maximumLevel, outputCapacity, padding2, padding3; };
