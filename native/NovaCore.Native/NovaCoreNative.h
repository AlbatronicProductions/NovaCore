...
struct alignas(16) NcPlanetaryEnvironment {
  ...
  float atmosphereHeightMetres, rayleighScaleHeightMetres, mieScaleHeightMetres, mieAnisotropy;
  float rayleighR, rayleighG, rayleighB, mieScattering;
  float cloudBaseHeightMetres, cloudTopHeightMetres, cloudCoverage, cloudDensity;
  float cloudGlobalScale, cloudDetailScale, cloudShadowStrength, maximumTerrainHeightMetres;
  float oceanSeaLevelMetres, oceanRoughness, oceanWaveScale, oceanWaveStrength;
