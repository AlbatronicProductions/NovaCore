...
public static class ScenarioCatalog
{
    ...
    [
        ...
        new(NovaCoreScenarioPreset.ContactCentered, "Development — Canonical Contact / Centered",
            ...
            NovaCoreStartingBody.None, null, null, NovaCoreWindowMode.Windowed, NovaCoreResolutionPreset.Resolution1280x720,
            NovaCoreDiagnosticsMode.PerformanceTelemetry, NovaCorePhysicalSurface.Generation3, true, null),
        new(NovaCoreScenarioPreset.ContactTilted, "Development — Canonical Contact / Tilted",
            "Live tilted/angular qualification box with retained contact publication and host-paced servicing.", NovaCoreScene.ContactTilted,
            NovaCoreStartingBody.None, null, null, NovaCoreWindowMode.Windowed, NovaCoreResolutionPreset.Resolution1280x720,
            NovaCoreDiagnosticsMode.PerformanceTelemetry, NovaCorePhysicalSurface.Generation3, true, null),
        ...
        new(NovaCoreScenarioPreset.EarthFullscreenNative, "Earth — Fullscreen Native",
            ...
            NovaCoreResolutionPreset.NativeDesktop, NovaCoreDiagnosticsMode.VulkanValidationAndPerformance, NovaCorePhysicalSurface.M12DNaturalTerrainCandidate, true, null),
        new(NovaCoreScenarioPreset.M12DSphericalBillboardGpuProof, "Development — Spherical Terrain GPU Proof",
            "Isolated P2S3 lifecycle, GPU preparation, triangle-culling, compaction, and indirect-draw proof.", NovaCoreScene.SphericalBillboardGpuProof,
            NovaCoreStartingBody.None, null, null, NovaCoreWindowMode.Windowed,
            NovaCoreResolutionPreset.Resolution1280x720, NovaCoreDiagnosticsMode.VulkanValidationAndPerformance,
            NovaCorePhysicalSurface.Generation3, true, null),
        new(NovaCoreScenarioPreset.NewEarthRenderer, "New Earth Renderer",
            "Production spherical terrain renderer for Earth exploration.",
